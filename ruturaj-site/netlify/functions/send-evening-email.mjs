// Scheduled function — fires at 5:00 PM IST (11:30 UTC) daily
...
export default async function handler() {
  ...
  const text = "EVENING CHECK-IN ⚡\nDay " + dayNum + " of 210 · " + dateStr
    ...
    + "\n\n₹1 crore CTC = the output of daily input. Stay the course.\nRuturaj Blueprint · 7 Month Plan · 2026";
  ...
  const html = '<!DOCTYPE html><html><head><meta charset="UTF-8"></head><body style="margin:0;padding:0;background:#080808;">'
    ...
    + '<p style="margin:0 0 8px;font-size:10px;letter-spacing:3px;color:' + accent + ';text-transform:uppercase;">TONIGHT\'S IGNITION</p>'
    ...
    + '<p style="margin:0 0 4px;font-size:9px;color:' + accent + ';letter-spacing:2px;text-transform:uppercase;">TONIGHT\'S MISSION</p>'
